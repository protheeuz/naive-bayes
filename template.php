...
<head>
	...
	<title>Aplikasi Sistem Penentuan Keputusan Kacanduan Game Metode Naive Bayes - 2024 Kacanduan Game Metode Naive Bayes - 2024 Metode Naive Bayes - Rizky <?php echo date('Y'); ?></title>
